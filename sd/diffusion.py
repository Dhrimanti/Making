...
class UNET_ResidualBlock(nn.Module):
    def __init__(self,in_channels:int, out_channels:int,n_time=1280):
        ...
        sself.groupnorm_merged=nn.GroupNorm(32,out_channels)
...
class UNET_AttentionBlock(NN.Module):
    def __init__(self,n_head:int,n_embed:int,d_context=768):
        ...
        self.attention_1=SelfAttention(n_head,channels,kernel_size=3,padding=1)
        self.layernorm_2=nn.LayerNorm(channels)
        self.attention_2=CrossAttention(n_head,channels,d_ccontext,in_proj_bias=False)
